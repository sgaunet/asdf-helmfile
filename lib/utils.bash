...
# GitHub repository for helmfile/helmfile
readonly GH_REPO="https://github.com/helmfile/helmfile"
readonly TOOL_NAME="helmfile"
readonly TOOL_TEST="helmfile version"

# Retry configuration for network operations
readonly MAX_RETRIES="${ASDF_HELMFILE_MAX_RETRIES:-3}"
readonly RETRY_DELAY="${ASDF_HELMFILE_RETRY_DELAY:-2}"

# Debug mode - set ASDF_HELMFILE_DEBUG=1 to enable verbose logging
readonly DEBUG="${ASDF_HELMFILE_DEBUG:-0}"
...
get_checksum_filename() {
	local version="$1"
	echo "helmfile_${version}_checksums.txt"
}
...
verify_checksum() {
	local version="$1"
	local file_path="$2"
	local checksum_url="$GH_REPO/releases/download/v${version}/helmfile_${version}_checksums.txt"
